...
urlpatterns = [
    ...
    # Comments
    path("post/<int:pk>/comments/new/", CommentCreateView.as_view(), name="comment-create"),   # ✅ required
    ...
    path("tags/<slug:tag_slug>/", PostByTagListView.as_view(), name="tag-posts"),   # ✅ required
